...
//
// Vendored verbatim from k2-fsa/sherpa-onnx's kotlin-api/OfflineRecognizer.kt (tag v1.13.4, matching
// the prebuilt libsherpa-onnx-jni.so in app/src/main/jniLibs/). Must stay in package
// com.k2fsa.sherpa.onnx - the native library's JNI symbols are linked against these exact
// fully-qualified class + field names, so renaming the package or altering the config data classes
// would break newFromFile()/decode() at runtime. See LLM Studio's WhisperSttEngine for actual usage.
// Companion files: OfflineStream.kt, FeatureConfig.kt, HomophoneReplacerConfig.kt, QnnConfig.kt, Vad.kt.
