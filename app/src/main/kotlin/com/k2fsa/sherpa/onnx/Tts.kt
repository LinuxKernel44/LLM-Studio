...
//
// Vendored verbatim from k2-fsa/sherpa-onnx's kotlin-api/Tts.kt (matching the prebuilt
// libsherpa-onnx-jni.so bundled in app/src/main/jniLibs/). This file MUST stay in this exact
// package (com.k2fsa.sherpa.onnx) - the native library's JNI method symbols are linked against
// this fully-qualified class name, so renaming the package would break System.loadLibrary() at
// runtime with UnsatisfiedLinkError. See LLM Studio's KokoroTtsEngine for the actual usage.
